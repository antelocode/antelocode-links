...
import { email, github, instagram, medium, whatsapp, youtube } from '@/data/dataLink'
import { faDiscord, faGithub, faInstagram, faMedium, faWhatsapp, faYoutube } from '@fortawesome/free-brands-svg-icons'
    ...
    return (
        <div className='flex flex-col items-center my-10 text-lg space-y-3'>
          ...
          <div className='flex items-center space-x-4 text-3xl'>
            ...
            <Link href={whatsapp} onMouseEnter={() => setHovered("Discord")} onMouseLeave={() => setHovered(false)}>
                <FontAwesomeIcon icon={faWhatsapp} className='text-[#189f33] hover:text-blue-300 duration-200'/>
            </Link>
            ...
            <Link href={medium} onMouseEnter={() => setHovered("Medium - Blog")} onMouseLeave={() => setHovered(false)}>
                <div className='p-1 rounded-md bg-[#181818] dark:bg-slate-50 text-sm hover:bg-slate-600 dark:hover:bg-slate-400 dark:hover:text-neutral-500 hover:text-neutral-500 duration-200'>
                    <FontAwesomeIcon icon={faMedium} className='text-white dark:text-[#181818]'/>
                </div>
            </Link>
          </div>
        </div>
